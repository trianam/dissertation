...
\begin{myfig}{Example of type 1 intersection between $\triangle \ve{a_1}\ve{b_1}\ve{c_1}$
    and $\triangle \ve{a_2}\ve{b_2}\ve{c_2}$.}{fig:trianglesIntersection1}
  \begin{tikzpicture}
...
\begin{myfig}{Example of type 2 intersection between $\triangle \ve{a_1}\ve{b_1}\ve{c_1}$
    and $\triangle \ve{a_2}\ve{b_2}\ve{c_2}$.}{fig:trianglesIntersection2}
  \begin{tikzpicture}
    \coordinate (A1) at (0,0);
    \coordinate (B1) at (4,5);
    \coordinate (C1) at (8,1);
