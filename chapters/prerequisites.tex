...
\subsection{Convex hull}\index{\bss!convex hull}
...
\subsection{Aligned vertices}\index{\bss!aligned vertices}
...
\subsection{End point interpolation}\index{\bss!end point interpolation}
...
\subsection{\acf{SA}}\index{Simulated annealing}
