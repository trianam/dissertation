...
$S_{m,\tau}$. Thus $\ve{S}(t)$ can be written as follows in the
...
\image{voronoi.eps}{Example of \ac{VD}, dashed lines are infinite edges.}{fig:voronoi}
\Cref{fig:voronoi} is an example of \ac{VD} built on some random
