...
\usepackage[linedheaders,eulerchapternumbers,subfig,beramono,eulermath,parts,dottedtoc]{classicthesis}
...
\NewDocumentCommand{\imagett}{mmmmmmo}{
  \begin{figure}
    \begin{center}
      \begin{tikzpicture}
        \node [figureFrame] (image1) at (0,0) {\includegraphics[width=.8\textwidth]{#1}};
        \node [figureFrame, below=1mm of image1] (image2) {\includegraphics[width=.8\textwidth]{#2}};
        %\coordinate[below=2.5cm of image2] (puntello);
        \node [figureFrame, below = 1mm of image2] (image3) {\includegraphics[width=.8\textwidth]{#3}};
        \node [figureFrame, below = 1mm of image3] (image4) {\includegraphics[width=.8\textwidth]{#4}};
        \IfNoValueTF{#7}
        {}
        {
          \begin{scope}[x={(image.south east)},y={(image.north west)}]
...
\newcommand{\sitesSet}{\ensuremath{I}\xspace}
\newcommand{\obsSet}{\ensuremath{O}\xspace}
...
\newcommand{\annBb}{2b\xspace}
\newcommand{\annC}{3\xspace}
\newcommand{\annCb}{3b\xspace}
