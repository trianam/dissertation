...
\newcommand{\degr}{Degree\xspace}
\newcommand{\metA}{Dijkstra in $G'$\xspace}
\newcommand{\metB}{Dijkstra in $G$\xspace}
\newcommand{\metC}{\acl{SA}\xspace}
\newcommand{\ypp}{with post proc.\xspace}
\newcommand{\npp}{no post proc.\xspace}
\newcommand{\yad}{with adaptive part.\xspace}
\newcommand{\nad}{no adaptive part.\xspace}
\newcommand{\testLab}[4]{#1; #2; #3; #4.}
