...
\newcommand{\nad}{\textbf{U}\xspace}
\newcommand{\nd}{\textbf{-}\xspace}
\newcommand{\testLab}[6]{Scene #1; $\ve{s}\shortrightarrow\ve{e}$ #2; Deg. #3; Meth. #4; Post proc. #5; Part. #6.}
\newcommand{\testLabAnn}[6]{Scene #1; $\ve{s}\shortrightarrow\ve{e}$ #2; Deg. #3; Meth. #4; Part. #5; Config. #6.}
