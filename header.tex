...
\tikzstyle{obstacle}=[fill=yellow, draw=black]
...
\newacro{MCM}{Monte Carlo Method}
\acrodefplural{MCM}{Monte Carlo Methods}
\newacro{SA}{Simulated Annealing}
\newacro{OTF}{Obstacle Triangular Face}
\acrodefplural{OTF}[OTFs]{Obstacle Triangular Faces}
\newacro{PDF}{Probability Density Function}
\newacro{PCLT}{Probability central limit theorem}
\newacro{PE}{Probable Error}
\newacro{LR}{Lagrangian Relaxation}
